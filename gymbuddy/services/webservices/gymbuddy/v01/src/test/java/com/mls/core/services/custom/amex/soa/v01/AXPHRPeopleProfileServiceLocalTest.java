...
@ContextConfiguration(classes=AXPHRPeopleProfileServiceLocalTest.class)
@DirtiesContext(classMode = ClassMode.AFTER_CLASS)
@DisableJmx(false)
@Category(SystemIntegrationTest.class)
public class AXPHRPeopleProfileServiceLocalTest {
	...
	private static URL getFileUrlByName(String fileName) {
		URL url = AXPHRPeopleProfileServiceLocalTest.class.getResource(fileName);
		if(url == null)
			url = AXPHRPeopleProfileServiceLocalTest.class.getClassLoader().getResource(fileName);
		if(url == null)
